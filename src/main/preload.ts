...
const electronApi = {
	...
	saveCollectionContent: (collection) => ipcRenderer.invoke(ValidChannel.UPDATE_COLLECTION, collection),
	executeCollectionLifecycleCommand: (command) => ipcRenderer.invoke(ValidChannel.COLLECTION_LIFECYCLE_COMMAND, command),
