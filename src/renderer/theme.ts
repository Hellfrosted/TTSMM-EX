...
function createAppThemeConfig(colors: typeof APP_THEME_COLORS): ThemeConfig {
	return {
		...
		token: {
			...
			boxShadowSecondary: `0 2px 8px ${colors.shadowSoft}`
		},
		components: {
			Layout: {
			...
			Menu: {
				...
				darkItemSelectedBg: colors.surfaceElevated,
				darkItemHoverBg: colors.menuHover,
				darkItemSelectedColor: colors.textBase,
				darkItemColor: colors.textSubtle,
				itemBorderRadius: 8,
				itemMarginInline: 10
			},
			Button: {
			...
			Input: {
				...
				hoverBorderColor: colors.fieldHover
			},
			InputNumber: {
				activeBorderColor: colors.primary,
				hoverBorderColor: colors.fieldHover
			...
			Table: {
				...
				rowSelectedBg: colors.tableRowSelected,
				rowSelectedHoverBg: colors.tableRowSelectedHover,
				borderColor: colors.border
			},
			Tabs: {
				itemActiveColor: colors.textBase,
				itemColor: colors.tabTextMuted,
			...
			Tag: {
				borderRadiusSM: 4,
				defaultBg: colors.surfaceElevated,
				defaultColor: colors.tagDefaultText
			},
			Collapse: {
				headerBg: colors.surfaceAlt,
				contentBg: colors.collapseBody,
				borderlessContentBg: colors.collapseBody
			},
			Descriptions: {
...
export const appTheme = createAppThemeConfig(APP_THEME_COLORS);
