export enum ValidChannel {
	...
	POPULATION_POOL_SCAN = 'population-pool-scan',
	POPULATION_POOL_DISABLE = 'population-pool-disable',
	POPULATION_POOL_RESTORE = 'population-pool-restore',
	POPULATION_POOL_STABLE_ADD = 'population-pool-stable-add',
	POPULATION_POOL_CREATE_WORKSHOP_REQUEST = 'population-pool-create-workshop-request',
