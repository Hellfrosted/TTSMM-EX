...
export const ipcInvokeChannels = {
	...
	resolveStartupCollection: ValidChannel.RESOLVE_STARTUP_COLLECTION,
	createCollectionLifecycle: ValidChannel.CREATE_COLLECTION_LIFECYCLE,
	deleteCollectionLifecycle: ValidChannel.DELETE_COLLECTION_LIFECYCLE,
