...
- Active Tailwind phase: commits 29-37 have established Tailwind conventions, mapped app tokens, converted shared loading primitives, migrated startup/loading screens, converted notification UI, migrated settings form layout, converted collection management modal UI, converted the Block Lookup shell UI, and converted the Collection view shell UI. Next up is commit 38: keep virtualized table internals on custom CSS.
