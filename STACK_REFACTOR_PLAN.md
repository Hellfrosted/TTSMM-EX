...
- Active Tailwind phase: commits 29-38 have established Tailwind conventions, mapped app tokens, converted shared loading primitives, migrated startup/loading screens, converted notification UI, migrated settings form layout, converted collection management modal UI, converted the Block Lookup shell UI, converted the Collection view shell UI, and explicitly preserved virtualized table internals on custom CSS. Next up is commit 39: remove obsolete CSS after each migration group.
